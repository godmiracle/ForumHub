...
private enum DiscourseMapper {
    ...
    static func threadDetail(source: ForumSource, detail: DiscourseTopicDetailResponse) -> ForumThread {
        ...
        return ForumThread(
            ...
            createdAtDate: ForumTime.parse(firstPost?.createdAt),
            lastReplyAtDate: ForumTime.parse(detail.lastPostedAt ?? firstPost?.createdAt),
    ...
    static func thread(
        ...
        return ForumThread(
            ...
            createdAtDate: ForumTime.parse(topic.createdAt),
            lastReplyAtDate: ForumTime.parse(topic.bumpedAt ?? topic.lastPostedAt ?? topic.createdAt),
